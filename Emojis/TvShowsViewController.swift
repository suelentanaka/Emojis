...
class TvShowsViewController: UIViewController, UITextFieldDelegate {
    ...
    private var savedIndex = UserDefaults.standard.integer(forKey: "indextvKey")
    private var score = 0
    private var highScore = UserDefaults.standard.integer(forKey: "scoretvKey")
    private var hint = 0
    private var savedHint = UserDefaults.standard.integer(forKey: "hintstvKey")
    ...
    func loadQuestions() {
        do {
            questionArray = try quizLoader.loadEmojis(forQuiz: "TvShows")
            loadNextTvQuestion()
        } catch {
            switch error {
    ...
    func saveScore() {
        UserDefaults.standard.set(score, forKey: "scoretvKey")
        highScore = UserDefaults.standard.integer(forKey: "scoretvKey")
        
        UserDefaults.standard.set(questionIndex, forKey: "indextvKey")
        savedIndex = UserDefaults.standard.integer(forKey: "indextvKey")
    }
    
    func saveHints() {
        UserDefaults.standard.set(hint, forKey: "hintstvKey")
        savedHint = UserDefaults.standard.integer(forKey: "hintstvKey")
    }
